    ...
    <footer className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8" data-uid="R5ILCUznPQL17suCCtbEl">
      <div className="max-w-7xl mx-auto" data-uid="WAVOSyFb_wDZ5darjGJ14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12" data-uid="i7msYWjVB9oakA0BpRhaw">
          ...
          <div data-uid="VTSkKCsHfreir7ZQATBUt">
          ...
          <div data-uid="LqoXia4w66zvG_KzS71R5">
          ...
          <div data-uid="uZzHP_9EG1CjTNxaQcLdG">
            <h4 className="text-lg font-bold mb-4" data-uid="ZEOSqhlgBCJnovDhquRSF">Follow Us</h4>
            <div className="flex space-x-4" data-uid="crUmRyc4z1kTLAHWKXz_F">
              <a
                href="#"
                className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-500 hover:shadow-lg transition duration-300"
                data-uid="zDag0Moqi5K9eiGraRHQr"
                aria-label="Facebook"
              >
                <svg
                  ...
                  data-uid="SJGw89UaJruYZSb8FL5-n"
                >
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-500 hover:shadow-lg transition duration-300"
                data-uid="htOvWwBOkp5cEmcU_ozFS"
                aria-label="Twitter"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  data-uid="fm2zJeym9C_2IgjA6eCTF"
                >
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-500 hover:shadow-lg transition duration-300"
                data-uid="efuInXX11hhcr1bDetIzc"
              ...
              >
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  data-uid="j22JjiUzGdM_MYBdTIwrz"
                >
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-500 hover:shadow-lg transition duration-300"
                data-uid="RP4CL4mHDWgZB_DufxtoX"
                aria-label="YouTube"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  data-uid="3aonT5cKNeUL0PmngCFD9"
                >
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 text-center text-gray-500 text-sm" data-uid="ud4ZB_43wxex0J7N_OGiz">
          © 2023 Stars. All rights reserved.
        </div>
      </div>
    </footer>
  )
