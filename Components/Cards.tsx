...
export default function Cards({
  ...
  return (
    <motion.div
      ...
      className="z-10 bg-white h-[430px] w-[329px] text-[14px] font-medium border border-[#C9C9C9] rounded-[14px] overflow-hidden shadow-sm"
    >
      ...
      <div className="px-[20px] pt-[2px] text-[#191C16]">
